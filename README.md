...
1. **Hazır Örnek Türkçe PDF Dosyaları (GitHub'da yer almaktadır):**
   * `public/samples/Ekstre_kamil özkundura.pdf`
   * `public/samples/Ekstre_kemal ozbegen.pdf`
   * `public/samples/Ekstre_sami soylu.pdf`
   * `public/samples/Ekstre_selami ozsahiner.pdf`
