        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14, position: 'sticky', top: 24 }}>
          ...
          {showAria && (
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.5 }} className="glass" style={{ padding: '18px 20px', border: '1px solid var(--accent)', display: 'flex', gap: 12, alignItems: 'flex-start' }}>
              ...
              <div style={{ fontSize: 12, color: 'var(--text2)', lineHeight: 1.5 }}><b style={{ color: 'var(--accent)' }}>ARIA:</b> &ldquo;{lang === 'tr' ? 'TÃ¼m harcamalarÄ±nÄ± girmene gerek yok.' : "You don't need to enter everything."}&rdquo;</div>
            </motion.div>
          )}
        </div>
      </div>
