                ...
                {showTip && (
                  ...
                  >
                    <p style={{ margin: '12px 0 8px 0', color: 'var(--text2)', lineHeight: 1.5 }}>
                      {lang === 'tr' 
                        ? 'Yapay zekanın banka ekstrelerini ne kadar başarılı analiz ettiğini test etmek için hazır bir ekstre dosyanız yoksa aşağıdaki yöntemlerden birini kullanabilirsiniz. En sağlıklı ve kararlı analiz sonuçları için lütfen Ekstre Pro aracıyla üretilen PDF dosyalarını kullanın!'
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginTop: 12 }}>
                      ...
                      <div style={{ borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: 10 }}>
                        <strong>🤖 {lang === 'tr' ? 'Yöntem B: Ekstre Pro ile Kendiniz Üretin' : 'Method B: Generate with Ekstre Pro'}</strong>
                        <p style={{ margin: '4px 0 8px 0', color: 'var(--text2)' }}>
                          {lang === 'tr' 
                            ? 'Terminalinizden projenin yerelindeki Python CLI betiğini doğrudan çalıştırarak saniyeler içinde zengin içerikli, özelleştirilmiş yeni ekstre PDF dosyaları oluşturabilirsiniz:'
                            : 'Run the Python CLI tool directly in your local terminal to dynamically generate personalized bank statement PDFs in seconds:'}
                        </p>
                        <code style={{ 
