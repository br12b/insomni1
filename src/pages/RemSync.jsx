      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', width: '100%' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 20, marginBottom: 40 }}>
           {[
             ...
             { id: 2, name: "BRIDGE v2", icon: Radio, color: "#6366f1" },
          ...
          <AnimatePresence mode="wait">
            {activePath === 1 && (
              <motion.div key="api" initial={{ opacity: 0 }} animate={{ opacity: 1 }} style={{ position: 'relative', zIndex: 1 }}>
                 ...
                 <button onClick={handleApiSync} disabled={isSyncing} className="btn-primary" style={{ width: '100%', padding: 20, borderRadius: 16, fontSize: 16, fontWeight: 900, background: '#000', color: '#fff' }}>
